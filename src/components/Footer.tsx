...
const Footer: React.FC<FooterProps> = ({ language }) => {
  ...
  return (
    <footer className="py-6 px-6 border-t border-white/10 mt-20 relative">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-sans uppercase tracking-[0.15em] text-white/70">
        <div>
        ...
        <div className="flex items-center">
          ...
          <a href="https://www.behance.net/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-accent transition-colors">BEHANCE</a>
          <span className="mx-4 text-white/20">|</span>
          <a href="https://github.com/danielmilkdesign" target="_blank" rel="noopener noreferrer" className="hover:text-brand-accent transition-colors">GITHUB</a>
        </div>
      </div>
